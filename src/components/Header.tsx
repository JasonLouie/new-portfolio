...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 w-full bg-green-950/70 backdrop-blur-sm min-h-17 flex items-center px-4 z-10 justify-end">
            <nav className={`${openNavigation ? "flex" : "hidden"} fixed top-17 left-0 right-0 bottom-0 font-space justify-center h-[calc(100vh-68px)] lg:static lg:flex lg:h-auto lg:mx-auto`}>
                <div className="relative flex flex-col items-center justify-center gap-y-7.5 mx-auto lg:flex-row lg:gap-x-5 xl:gap-x-7">
                    {navLinks.map((link) => {
